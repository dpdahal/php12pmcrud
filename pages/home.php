<?php
$sliderQuery = "SELECT * FROM tbl_slider WHERE status=1 ORDER BY id DESC LIMIT 4";
$sliderQuery = mysqli_query($connection, $sliderQuery);
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="slick_slider">
                <?php foreach ($sliderQuery as $slide): ?>
                    <div class="single_iteam"><a href="">
                            <img src="<?= base_url('public/images/slider/' . $slide['image']) ?>"
                                 alt=""></a>
                        <div class="slider_article">
                            <h2>
                                <a class="slider_tittle" href="">
                                    <?= $slide['title'] ?></a></h2>
                            <p>
                                <?= substr(strip_tags($slide['description']), 0, 150) ?>
                                <a href="">Read more</a>
                            </p>
                        </div>
                    </div>
                        ...
                        <ul class="business_catgnav">
                            <li>
                                <figure class="bsbig_fig  wow fadeInDown"><a class="featured_img"
                                                ...
                                                src="images/featured_img1.jpg" alt=""> <span class="overlay"></span>
                                    </a>
                                    <figcaption><a href="pages/single_page.html">Proin rhoncus consequat nisl eu ornare
                                            mauris</a></figcaption>
                                    <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <aside class="right_content">
                <div class="single_sidebar">
                    ...
                    <ul class="spost_nav">
                        <li>
                            <div class="media wow fadeInDown"><a href="pages/single_page.html" class="media-left"> <img
